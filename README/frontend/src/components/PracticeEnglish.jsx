...
export default function PracticeEnglish() {
  ...
  const level = Math.floor(xp / xpThreshold) + 1;
  ...
  const sendChatMessage = async () => {
    ...
    try {
      const res = await fetch('http://localhost:5000/api/english/chat', {
        method: 'POST',
  ...
  useEffect(() => {
    ...
    Promise.all([
      fetch('http://localhost:5000/api/english/resources').then(res => res.json()),
      fetch('http://localhost:5000/api/english/flashcards').then(res => res.json()),
      fetch('http://localhost:5000/api/english/scores').then(res => res.json())
  ...
  const saveScore = async (score, type) => {
    try {
      const res = await fetch('http://localhost:5000/api/english/scores', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const generateQuiz = async () => {
    setMcqLoading(true);
    try {
      const res = await fetch('http://localhost:5000/api/english/generate-mcq', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleEvaluate = async (type) => {
    ...
    setFeedback(null);
    try {
      const res = await fetch('http://localhost:5000/api/english/evaluate', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleRewrite = async () => {
    ...
    try {
      const res = await fetch('http://localhost:5000/api/english/rewrite', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleAutoGenerate = async () => {
    ...
    setRewriteLoading(true);
    try {
      const res = await fetch('http://localhost:5000/api/english/generate-email', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const generateLesson = async () => {
    ...
    try {
      const res = await fetch('http://localhost:5000/api/english/generate-lesson', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const generateReading = async () => {
    ...
    try {
      const res = await fetch('http://localhost:5000/api/english/generate-reading', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const submitReadingQuiz = () => {
    ...
    if (pct === 100) setXP(prev => prev + 25);
    else setXP(prev => prev + 10);
  };
  ...
  return (
    <div className="container" style={{ padding: '40px 24px', maxWidth: '1100px', display: 'flex', gap: '40px' }}>
            ...
            <div className="card" style={{ marginBottom: '28px', display: 'flex', gap: '16px', flexWrap: 'wrap', alignItems: 'flex-end' }}>
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    const res = await fetch('http://localhost:5000/api/programming/challenge', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ topic: progTopic, difficulty: progDifficulty }) });
                    const data = await res.json();
                    if (data.success) { setProgChallenge(data.data); setXP(prev => prev + 15); }
                  } catch(err) { console.error(err); }
            ...
            {progChallenge && (
              <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                  ...
                  <button onClick={() => { setShowSolution(!showSolution); if (!showSolution) setXP(prev => prev - 5); }} className="btn btn-secondary" style={{ backgroundColor: showSolution ? '#fee2e2' : undefined, color: showSolution ? '#991b1b' : undefined, border: showSolution ? '1px solid #ef4444' : undefined }}>
            ...
            <div className="card" style={{ marginBottom: '28px', display: 'flex', gap: '16px', flexWrap: 'wrap', alignItems: 'flex-end' }}>
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    const res = await fetch('http://localhost:5000/api/cs/question', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ topic: csTopic }) });
                    const data = await res.json();
              ...
              <div className="card" style={{ marginBottom: '32px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '24px' }}>
                  {currentMcqIdx < mcqs.length - 1 ? (
                    ...
                    <button className="btn btn-primary" disabled={selectedOption === null} onClick={() => { setIsQuizActive(false); setXP(prev => prev + 10); }}>
                      Finish Quiz
                    </button>
                  )}
                </div>
